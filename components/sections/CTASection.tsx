...
return ( <section className="bg-white py-20"> <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8"> <div className="overflow-hidden rounded-2xl bg-[var(--color-primary)] px-6 py-12 text-center shadow-lg sm:px-12">
